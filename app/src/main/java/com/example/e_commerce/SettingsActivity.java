...
public class SettingsActivity extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        storageProfilePrictureRef = FirebaseStorage.getInstance().getReference().child("Profile " +
                "pictures");
        ...
        userPhoneEditText = (EditText) findViewById(R.id.change_phone_number);
        addressEditText = (EditText) findViewById(R.id.change_buyer_address);
    ...
    private void uploadImage()
    {
        ...
        if (imageUri != null) {
            final StorageReference fileRef = storageProfilePrictureRef
                    .child(Prevalent.currOnlineUser.getPhone() + ".jpg");
                        ...
                        public void onComplete(@NonNull Task<Uri> task)
                        {
                            if (task.isSuccessful()) {
                                ...
                                startActivity(new Intent(SettingsActivity.this,
                                        HomeActivity.class));
                                Toast.makeText(SettingsActivity.this, "Profile Info update " +
                                 ...
                                 final EditText userPhoneEditText, final EditText addressEditText)
    {
        DatabaseReference UsersRef =
                FirebaseDatabase.getInstance().getReference().child("Users").child(Prevalent.currOnlineUser.getPhone());
