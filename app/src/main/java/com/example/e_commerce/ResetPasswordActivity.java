...
public class ResetPasswordActivity extends AppCompatActivity
{
    ...
    protected void onStart()
    {
        ...
        if(check.equals("settings"))
        {
            ...
            questionsTitle.setText("Set the answers for the security questions");
            verifyBtn.setText("Update");
    ...
    private void setAnswers()
    {
        ...
        if(question1.equals("") && question2.equals(""))
        {
            ...
            questionsMap.put("answer1", answer1);
            questionsMap.put("answer2", answer2);

            ref.child("Security Questions").updateChildren(questionsMap).addOnCompleteListener(new OnCompleteListener<Void>()
            {
                @Override
                public void onComplete(@NonNull Task<Void> task)
                {
                    ...
                    {
                        Toast.makeText(ResetPasswordActivity.this, "You have set answers successfully.",
                ...
                public void onDataChange(@NonNull DataSnapshot dataSnapshot)
                {
                    if(dataSnapshot.exists())
                    {
                        ...
                        if(dataSnapshot.hasChild("Security Questions"))
                        {
                            ...
                            {
                                Toast.makeText(ResetPasswordActivity.this, "Your 1st answer is wrong.",
                                        Toast.LENGTH_SHORT).show();
                            } else if(!ans2.equals(answer2)){
                                Toast.makeText(ResetPasswordActivity.this, "Your 2nd answer is wrong.",
                                        Toast.LENGTH_SHORT).show();
                            } else {
